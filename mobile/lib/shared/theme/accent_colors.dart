...
const accentColors = [
  ...
  // Accenture Purple — the brand accent. This is the rebrand of upstream's
  // 'Purple' slot: only the visible layer (name + colors) changes; the
  // wireValue stays '#a855f7' because it is the desktop<->mobile sync
  // identifier, so migration and cross-device sync keep working.
  AccentColor(
    name: 'Accenture',
...
/// New default: Accenture Purple — the rebranded 'Purple' slot at index 8.
///
