 ...
 *  tree transitively imports a .css file the test-loader has no CSS stub for.
 *  The
...
//
// AgentSessionTranscriptList cannot render under node:test (it transitively
// imports a .css file the test-loader can't stub). The test below verifies the
