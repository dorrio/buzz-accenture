...
export const WELCOME_GUIDE_AGENT_NAME = "Aria";
...
export const WELCOME_GUIDE_INTRO_MESSAGE =
  "Hi, I'm Aria. Welcome to Accenture Connect.\n\nI can help you get oriented, answer questions, and make the first few steps feel less mysterious.\n\nFeel free to ask me what else you can do in Accenture Connect, or just talk through what you want to build.";
